...
vim.keymap.set('n', '<F43>', '<cmd>RunCMakeBuildWithTarget<CR>', { desc = 'LSP: Run cmake build with target' })
vim.keymap.set('n', '<C-S-F7>', '<cmd>RunCMakeBuildWithTarget<CR>', { desc = 'LSP: Run cmake build with target' })
