...
return {
   {
      ...
      config = function()
         ...
         vim.api.nvim_create_user_command('ShowSelectedConfigurePreset', function()
            vim.print(
               'Current CMake Configure Preset: ',
         ...
         end, { desc = '[d]apview [s]how [s]copes' })
         vim.keymap.set('n', '<leader>dse', function()
            vim.cmd('DapViewShow exceptions')
         end, { desc = '[d]apview [s]how [e]xeptions' })
         vim.keymap.set('n', '<leader>dsb', function()
            vim.cmd('DapViewShow breakpoints')
         end, { desc = '[d]apview [s]how [b]reakpoints' })
         vim.keymap.set('n', '<leader>dst', function()
            vim.cmd('DapViewShow threads')
         end, { desc = '[d]apview [s]how [t]hreads' })
         ...
         end, { desc = '[d]apview [j]ump to [s]copes' })
         vim.keymap.set('n', '<leader>dje', function()
            vim.cmd('DapViewJump exceptions')
         end, { desc = '[d]apview [j]ump to [e]xeptions' })
         vim.keymap.set('n', '<leader>djb', function()
            vim.cmd('DapViewJump breakpoints')
         end, { desc = '[d]apview [j]ump to [b]reakpoints' })
         vim.keymap.set('n', '<leader>djt', function()
            vim.cmd('DapViewJump threads')
         end, { desc = '[d]apview [j]ump to [t]hreads' })
         ...
         end, { desc = '[l]aunch server in [d]ebuggee', noremap = true })
