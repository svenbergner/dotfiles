...
return {
   ...
   opts = function(_, opts)
      ...
      vim.keymap.set("i", "<C-c>", function() require("luasnip.extras.select_choice")() end, { desc = 'select snippt choice' })
      vim.keymap.set("n", "<C-c>", function() require("luasnip.extras.select_choice")() end, { desc = 'select snippt choice' })
      return opts
   end,
}
