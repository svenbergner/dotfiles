...
return {
   ...
   config = function()
      ...
      vim.keymap.set('n', '<leader>gn', function() require('gitsigns').nav_hunk('next') end, { desc = '[g]it Hunk [n]ext' })
      vim.keymap.set('n', '<leader>gN', function() require('gitsigns').nav_hunk('prev') end, { desc = '[g]it hu[N]k previous' })
   end
}
