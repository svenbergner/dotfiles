...
M.setup_layout = function(wezterm)
   ...
   wezterm.on('gui-startup', function()
      ...
      M.addTab(window, home_dir .. '/Repos/Content/StP/repo', 'Content StP repo', 'nvim\n')
      M.addTab(window, home_dir .. '/Repos/Content/StP/32', 'Content StP 32', 'nvim\n')
      M.addTab(window, home_dir .. '/Repos/Content/StP/31', 'Content StP 31', 'nvim\n')
      -- M.addTab(window, home_dir .. '/Repos/Content/StP/30', 'Content StP 30', 'nvim\n')
